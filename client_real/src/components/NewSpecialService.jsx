...
const NewSpecialService = (props) => {
    ...
    const onSubmit = async () => {
        const res = await axios.post(`${BASE_URL}/newspecialservice`, newservice)
    }
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title id="contained-modal-title-vcenter">
          Create New Special Occasion Service
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
...
export default NewSpecialService